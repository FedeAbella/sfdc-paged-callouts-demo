...
TL;DR: If you don't really care about the whole structure of the thing and want to get right into the action, jump ahead to [this section](# TryIt)
...
## Ok, that's good and all, but I want to try it out for myself now. How do I do that? <a name="TryIt"></a>
